...
StepperController::StepperController()
  : step_pin_{ LEFT_STEP_PIN, RIGHT_STEP_PIN },
...
void StepperController::set_UV_value(int UV_value) {
  if (UV_value != UV_value_) {
    UV_value_ = UV_value;
    //pen_controller_->write(UV_value);
    digitalWrite(UV_PIN, UV_value);
    delay(100);
  }
}


int StepperController::get_UV_value() {
  return UV_value_;
}
